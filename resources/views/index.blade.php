...
@section('content')
    <div class="slides">
        <div class="owl-carousel">
            <div><img src="img/slides/slide-1.jpg"></div>
            <div><img src="img/slides/slide-2.jpg"></div>
            <div><img src="img/slides/slide-3.jpg"></div>
        </div>
    </div>
        ...
        <div class="container-veiculos-home">
            ...
            @foreach($result_veiculos as $veiculo)
                <div class="container-veiculos-home-div">
                    <img src="img/veiculos/{{ $veiculo->imagem == '' ? 'foto-em-breve.jpg' : $veiculo->imagem }}" title="{{ $veiculo->marca }} > {{ $veiculo->modelo }}" alt="{{ $veiculo->marca }} > {{ $veiculo->modelo }}">
